...
their activity is. Applied across a KEGG collection (\code{scan\_pathways.py}) it gives an
unbiased screen for the pathways most likely to be differentially regulated across the tissue,
with the annotation-based AUCs above serving as positive controls.
