...
---reconstructs the anatomy. Component~0 is a striatal medium-spiny-neuron programme
...
\code{colorpath/spatial.py} (10x Space~Ranger \code{.h5} loading, linear library-size
